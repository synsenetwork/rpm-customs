...
# Every binary subpackage is named qemu-synse-<suffix>, but replaces the
# matching Fedora qemu-<suffix> package at the dependency-solver level.
%define replace_qemu_package() \
Provides: qemu-%{1} = %{evr} \
Conflicts: qemu-%{1}
...
%define requires_package_qemu_pr_helper Requires: %{name}-pr-helper = %{evr}
...
URL: https://github.com/synsenetwork/qemu
Provides: qemu = %{evr}
Conflicts: qemu
...
Source0: %{url}/archive/%{commit}/%{name}-%{version}-%{commit}.tar.gz
...
%package -n qemu-synse-img
%replace_qemu_package img
Summary: QEMU command line tool for manipulating disk images
%description -n qemu-synse-img
This package provides a command line tool for manipulating disk images.


%package -n qemu-synse-guest-agent
%replace_qemu_package guest-agent
Summary: QEMU guest agent
%description -n qemu-synse-guest-agent
%{name} is an open source virtualizer that provides hardware emulation for
the KVM hypervisor.
...
%package -n qemu-synse-pr-helper
%replace_qemu_package pr-helper
...
%if %{have_libblkio}
%package  block-blkio
%replace_qemu_package block-blkio
...
%package  block-curl
%replace_qemu_package block-curl
...
%if %{have_block_iscsi}
%package  block-iscsi
%replace_qemu_package block-iscsi
...
%if %{have_block_rbd}
%package  block-rbd
%replace_qemu_package block-rbd
...
%package  block-ssh
%replace_qemu_package block-ssh
...
%if %{have_opengl}
%package  ui-opengl
%replace_qemu_package ui-opengl
...
# Fedora specific
%package  block-dmg
%replace_qemu_package block-dmg
...
%replace_qemu_package block-gluster
...
%if %{have_block_nfs}
%package  block-nfs
%replace_qemu_package block-nfs
...
%package  audio-alsa
%replace_qemu_package audio-alsa
...
%if %{have_dbus_display}
%package  audio-dbus
%replace_qemu_package audio-dbus
...
%package  audio-oss
%replace_qemu_package audio-oss
...
%replace_qemu_package audio-pipewire
...
%package  audio-sdl
%replace_qemu_package audio-sdl
...
%if %{have_jack}
%package  audio-jack
%replace_qemu_package audio-jack
...
%package  ui-curses
%replace_qemu_package ui-curses
...
%replace_qemu_package ui-egl-headless
...
%if %{have_brlapi}
%package  char-baum
%replace_qemu_package char-baum
...
%replace_qemu_package device-display-virtio-gpu
...
%replace_qemu_package device-display-virtio-gpu-gl
...
%replace_qemu_package device-display-virtio-gpu-rutabaga
...
%replace_qemu_package device-display-virtio-gpu-pci
...
%replace_qemu_package device-display-virtio-gpu-pci-gl
...
%replace_qemu_package device-display-virtio-gpu-pci-rutabaga
...
%replace_qemu_package device-display-virtio-gpu-ccw
...
%replace_qemu_package device-display-virtio-vga
...
%replace_qemu_package device-display-virtio-vga-gl
...
%replace_qemu_package device-display-virtio-vga-rutabaga
...
%replace_qemu_package device-uefi-vars
...
%replace_qemu_package device-usb-host
...
%replace_qemu_package device-usb-redirect
...
%replace_qemu_package device-usb-smartcard
...
%replace_qemu_package device-display-vhost-user-gpu
...
%replace_qemu_package ui-spice-core
...
%replace_qemu_package ui-spice-app
...
%replace_qemu_package device-display-qxl
Summary: QEMU QXL display device
Requires: %{name}-common%{?_isa} = %{evr}
Requires: %{name}-ui-spice-core%{?_isa} = %{evr}
...
%package  char-spice
%replace_qemu_package char-spice
...
%package  audio-spice
%replace_qemu_package audio-spice
...
%if %{have_kvm}
%package kvm
%replace_qemu_package kvm
Summary: QEMU metapackage for KVM support
Requires: %{name}-%{kvm_package} = %{evr}
%description kvm
...
%package kvm-core
%replace_qemu_package kvm-core
Summary: QEMU metapackage for KVM support
Requires: %{name}-%{kvm_package}-core = %{evr}
...
%package user-binfmt
%replace_qemu_package user-binfmt
Summary: QEMU user mode emulation of qemu targets
Requires: %{name}-user = %{evr}
...
%if %{user_static}
%package user-static
%replace_qemu_package user-static
...
Requires: %{name}-user-static-arm
Requires: %{name}-user-static-hexagon
Requires: %{name}-user-static-m68k
Requires: %{name}-user-static-microblaze
Requires: %{name}-user-static-mips
Requires: %{name}-user-static-or1k
Requires: %{name}-user-static-ppc
Requires: %{name}-user-static-riscv
Requires: %{name}-user-static-sh4
Requires: %{name}-user-static-sparc
Requires: %{name}-user-static-x86
Requires: %{name}-user-static-xtensa
Obsoletes: qemu-user-static-nios2 <= %{evr}
Obsoletes: qemu-user-static-cris <= %{evr}
%if %{have_64bit}
Requires: %{name}-user-static-aarch64
Requires: %{name}-user-static-alpha
Requires: %{name}-user-static-hppa
Requires: %{name}-user-static-loongarch64
Requires: %{name}-user-static-s390x
%else
...
%replace_qemu_package user-static-aarch64
...
%replace_qemu_package user-static-alpha
...
%replace_qemu_package user-static-arm
...
%replace_qemu_package user-static-hexagon
...
%replace_qemu_package user-static-hppa
...
%replace_qemu_package user-static-loongarch64
...
%replace_qemu_package user-static-m68k
...
%replace_qemu_package user-static-microblaze
...
%replace_qemu_package user-static-mips
...
%replace_qemu_package user-static-or1k
...
%replace_qemu_package user-static-ppc
...
%replace_qemu_package user-static-riscv
...
%replace_qemu_package user-static-s390x
...
%replace_qemu_package user-static-sh4
...
%replace_qemu_package user-static-sparc
...
%replace_qemu_package user-static-x86
...
%replace_qemu_package user-static-xtensa
...
%replace_qemu_package system-aarch64
...
%replace_qemu_package system-aarch64-core
Summary: QEMU system emulator for AArch64
Requires: %{name}-common = %{evr}
...
%replace_qemu_package system-alpha
...
%replace_qemu_package system-alpha-core
Summary: QEMU system emulator for Alpha
Requires: %{name}-common = %{evr}
...
%package system-arm
%replace_qemu_package system-arm
...
%replace_qemu_package system-arm-core
Summary: QEMU system emulator for ARM
Requires: %{name}-common = %{evr}
...
%package system-avr
%replace_qemu_package system-avr
...
%replace_qemu_package system-avr-core
Summary: QEMU system emulator for AVR
Requires: %{name}-common = %{evr}
...
%package system-hppa
%replace_qemu_package system-hppa
...
%replace_qemu_package system-hppa-core
Summary: QEMU system emulator for hppa
Requires: %{name}-common = %{evr}
...
%replace_qemu_package system-loongarch64
...
%replace_qemu_package system-loongarch64-core
Summary: QEMU system emulator for LoongArch (LA64)
Requires: %{name}-common = %{evr}
...
%package system-m68k
%replace_qemu_package system-m68k
...
%replace_qemu_package system-m68k-core
Summary: QEMU system emulator for ColdFire (m68k)
Requires: %{name}-common = %{evr}
...
%replace_qemu_package system-microblaze
...
%replace_qemu_package system-microblaze-core
Summary: QEMU system emulator for Microblaze
Requires: %{name}-common = %{evr}
...
%package system-mips
%replace_qemu_package system-mips
...
%replace_qemu_package system-mips-core
Summary: QEMU system emulator for MIPS
Requires: %{name}-common = %{evr}
...
%package system-or1k
%replace_qemu_package system-or1k
...
%replace_qemu_package system-or1k-core
Summary: QEMU system emulator for OpenRisc32
Requires: %{name}-common = %{evr}
...
%package system-ppc
%replace_qemu_package system-ppc
...
%replace_qemu_package system-ppc-core
Summary: QEMU system emulator for PPC
Requires: %{name}-common = %{evr}
Requires: openbios
Requires: SLOF
...
%replace_qemu_package system-riscv
...
%replace_qemu_package system-riscv-core
Summary: QEMU system emulator for RISC-V
Requires: %{name}-common = %{evr}
...
%package system-rx
%replace_qemu_package system-rx
...
%replace_qemu_package system-rx-core
Summary: QEMU system emulator for RX
Requires: %{name}-common = %{evr}
...
%replace_qemu_package system-s390x
...
%replace_qemu_package system-s390x-core
Summary: QEMU system emulator for S390
Requires: %{name}-common = %{evr}
...
%package system-sh4
%replace_qemu_package system-sh4
...
%replace_qemu_package system-sh4-core
Summary: QEMU system emulator for SH4
Requires: %{name}-common = %{evr}
...
%replace_qemu_package system-sparc
...
%replace_qemu_package system-sparc-core
Summary: QEMU system emulator for SPARC
Requires: %{name}-common = %{evr}
Requires: openbios
...
%replace_qemu_package system-tricore
...
%replace_qemu_package system-tricore-core
Summary: QEMU system emulator for tricore
Requires: %{name}-common = %{evr}
...
%package system-x86
%replace_qemu_package system-x86
...
%replace_qemu_package system-x86-core
Summary: QEMU system emulator for x86
Requires: %{name}-common = %{evr}
...
%replace_qemu_package system-xtensa
...
%replace_qemu_package system-xtensa-core
Summary: QEMU system emulator for Xtensa
Requires: %{name}-common = %{evr}
...
%preun -n qemu-synse-guest-agent
%systemd_preun qemu-guest-agent.service
%postun -n qemu-synse-guest-agent
...
%files -n qemu-synse-guest-agent
...
* Sat Aug 08 2026 Kristián Kekeš <gamerix2006@gmail.com> - 2:10.2.2-2
- Build from synsenetwork/qemu commit aba531a
- Include the custom coherent hardware identity profile
