...
# Pinned tip of https://github.com/synsenetwork/edk2-shadow/tree/amd
%global edk2_commit f89180058fe5860cfe7772654f72ecb792eb59f8
...
Source20:       40-edk2-shadow-amd-x64.json
...
%description
edk2-shadow-amd provides a compact OVMF build carrying AutoVirt's AMD firmware
...
edk2-ovmf. It is mutually exclusive with edk2-shadow-intel.
...
install -Dm0644 %{SOURCE20} \
    %{buildroot}%{_datadir}/qemu/firmware/40-edk2-shadow-amd-x64.json
