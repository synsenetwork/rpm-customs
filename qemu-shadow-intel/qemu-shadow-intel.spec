...
# Pinned tip of https://github.com/synsenetwork/qemu-shadow/tree/intel
%global qemu_commit 7fc32e09b4fc7eb76fca0e4bd6d30d1fae9e9386
...
Conflicts:      qemu-shadow-amd

%description
qemu-shadow-intel is a compact, KVM-only x86_64 QEMU build carrying the Intel
...
split QEMU packages. It is mutually exclusive with qemu-shadow-amd.
...
# libvirt and QEMU must resolve OVMF from the required edk2-shadow-intel RPM.
